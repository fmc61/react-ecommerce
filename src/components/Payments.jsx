...
function Payments() {
  ...
  return (
    <div className="lg:w-1/3">
        <div className="border p-4 rounded-g">
            ...
            <div className="mt-6 border-t pt-6">
                ...
                <div className="mt-6">
                    <button className="w-full  bg-pink-600 text-white px-4 py-2 rounded-lg shadow hover:bg-pink-700 transition-colors duration-200">Proceed To Chechout</button>
                </div>
            </div>
        </div>
    </div>
